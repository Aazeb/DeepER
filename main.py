from load_data import Data, MulData
import numpy as np
import torch
...
class Experiment:
    ...
    def train_and_eval(self):
        ...
        elif model_name.lower() == "deeper":
            model = DeepER(d, self.ent_vec_dim, self.rel_vec_dim, **self.kwargs)
        elif model_name.lower() == "mdeeper":
            model = MDeepER(d, self.ent_vec_dim, self.rel_vec_dim, **self.kwargs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algorithm', type=str, default="deeper", nargs="?",
                    help='Which algorithm to use: HypER, ConvE, or DeepER')
    parser.add_argument('--dataset', type=str, default="FB15k-237", nargs="?",
                    help='Which dataset to use: FB15k-237, WN18RR, YAGO3-10, Codex-m, FB15k, WN18, kinship')
    parser.add_argument('--mode', type=str, default="uni", nargs="?",
                    help='Unimodal / Multimodal')
    ...
    if args.mode.lower() == "uni":
        d = Data(data_dir=data_dir, reverse=True)
    elif args.mode.lower() == "mul":
        d = MulData(data_dir=data_dir, reverse=True)
    experiment = Experiment(model_name, num_iterations=800, batch_size=128, learning_rate=0.005,
